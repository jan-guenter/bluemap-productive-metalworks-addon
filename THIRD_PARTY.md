...
| BlueMap Add-on Adapter API | `0.1.0-alpha.2` / `e81f08bc4bfbf02d810ec8949a019130e2e61634` | MIT | Four source-compiled helpers | Source only |
| Productive Metalworks profile | `productivemetalworks-1.21.1-1.15.1` | See `provenance/upstreams.json` | Exact installed-artifact and resource evidence only | No |

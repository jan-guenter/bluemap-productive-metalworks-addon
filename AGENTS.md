# Agent guide for the Productive Metalworks BlueMap add-on
...
- Exact profile `productivemetalworks-1.21.1-1.15.1`
...
- `-PproductiveMetalworksJar=/path/to/productivemetalworks-1.21.1-1.15.1.jar`
